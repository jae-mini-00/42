...
SOURCES=(
  ...
  "$PROJECT_ROOT/src/server/AutoindexResponse.cpp"
  "$PROJECT_ROOT/src/config/ConfigError.cpp"
  "$PROJECT_ROOT/src/server/MultipartParser.cpp"
  ...
  "$PROJECT_ROOT/src/server/ResponseErrors.cpp"
  "$PROJECT_ROOT/src/server/ResponseHandlers.cpp"
  "$PROJECT_ROOT/src/server/DefaultError.cpp"
  "$PROJECT_ROOT/src/server/Client.cpp"
  "$PROJECT_ROOT/src/server/Server.cpp"
  "$PROJECT_ROOT/src/server/Server_io.cpp"
  "$PROJECT_ROOT/src/server/Server_dispatch.cpp"
  "$PROJECT_ROOT/src/server/Server_connections.cpp"
  "$PROJECT_ROOT/src/server/Session.cpp"
  "$PROJECT_ROOT/src/server/ResponseUtils.cpp"
  "$PROJECT_ROOT/src/core/EPoll.cpp"
  "$PROJECT_ROOT/src/framing_test_dummy.cpp"
  "$PROJECT_ROOT/src/core/Errors.cpp"
  "$PROJECT_ROOT/src/core/FileDescriptor.cpp"
  "$PROJECT_ROOT/src/core/utils.cpp"
)
